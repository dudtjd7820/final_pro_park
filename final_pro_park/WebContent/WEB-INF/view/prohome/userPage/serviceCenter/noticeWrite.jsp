...
<script type="text/javascript">
	...
	function save() {
		...
		$("#f_save").attr("action", "noticeIns.park");
		$("#f_save").submit();
	}
	/* 글 등록 버튼 누르면 처리 끝 */
</script>
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-3">
				<ul class="block-menu" style="width: auto;">
					...
					<li><a class="faq-button active" href="notice.park"> <i
			...
			<div class="section-title line-style no-margin"><h3 class="title">글 작성</h3></div>
				<div class="col-md-12">
						...
						<!-- 글 등록 버튼 끝 -->
						<!-- 글 취소 버튼 시작-->
							<a href="notice.park" class="btn btn-default" >취소</a></span>
						<!-- 글 취소 버튼 끝-->
						</form>
					</div>
			</div>
