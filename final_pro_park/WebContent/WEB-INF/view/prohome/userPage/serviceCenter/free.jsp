...
<!-- 헤더 밑 메뉴 그림 시작 -->
	...
	<div class="container">
		...
		<!-- 왼쪽 메뉴리스트 시작 -->
			...
			<div class="section-title line-style no-margin"><h3 class="title">자유게시판</h3></div>
				<table id="dg_board" class="easyui-datagrid" 
					style="width: 850px; height: 500px"
					data-options="singleSelect:true,collapsible:true,method:'get',url:'jsonFreeSel.park'">
					<thead>
						<tr>
							<th
				...
				<a href="freeWrite.park" class="btn btn-default btn-lg" style="width: 120px" >글 작성</a></span>
				<!-- 글쓰기 버튼 끝-->
			</div>
		</div>
	</div>
